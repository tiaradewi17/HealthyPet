...
class HomeScreen extends StatelessWidget {
  ...
  BottomNavigationBar _bottomNavigationBar(BuildContext context) =>
      BottomNavigationBar(
        ...
        onTap: (index) {
          if (index == 1) {
            // Jika ikon 'FeatherIcons.heart' ditekan
            Navigator.push(
              context,
              MaterialPageRoute(
            ...
            // Jika indeks adalah 3, arahkan ke Profile
            Navigator.push(
              context,
              MaterialPageRoute(
            ...
            // Tindakan untuk ikon lainnya
            // Misalnya, Anda dapat menambahkan logika untuk ikon lain di sini.
          }
        },
      );
